	...
	<div class="container">
				...
				<div style="height:134px;float:left">
					...
					<div style="padding-top:0px">
						<form class="navbar-form navbar-left"
							action="productServlet?method=searchProducts" method="post">
							<div class="form-group">
								<input type="text" class="form-control"
									placeholder="Product information..." style="width:260px"
									name="searchContent">
							</div>
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<div>
					<span
						style="font-family:Myriad Pro;font-size:40px;display:block;text-align:center">About
						Me</span> <br />
					<hr style="border: 1.5px solid purple;margin-top:-20px" />
				</div>

				<div class="mystyle">
								<img src="Images/Website/WifeTookThePhoto.jpg" width="400px" height="550px" style="float:right;margin-top:0px">
				<span><strong>Chinese Name:</strong> QinJiangbo</span><br>
				<span><strong>English Name:</strong> Mark</span><br>
				<span><strong>French Name:</strong> Richard</span><br>
				<span><strong>Student Number:</strong> 2012302580314</span>
</div>
				<br>
				<p style="font-family:cursive;font-size:34px;color:purple">&nbsp;&nbsp;&nbsp;&nbsp;Hello,dear
					teacher! This project took me about two weeks to complish.
					Indeed,it is really hard for us to implement all the requirements
					once, so I try my best to realise these requirements in more than
					10 iterations! My motto is-the one who wants to wear the crown
					bears the crown! So, after many times, it finally satifies me! I
					hope it also satisifes you ,too! Thank you!</p>
			</div>
		</div>
	</div>
