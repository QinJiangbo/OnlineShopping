...
<title>YiGou OnlineShopping Login</title>
...
<body style="background:url(Images/Website/img11.jpg) repeat left top">
	<div class="myfont" style="margin-top:140px;margin-left:500px;">
		<span>YiGou Login</span>
	</div>
	<div style="margin-top:50px;margin-left:540px;width:560px">
		<form class="form-horizontal" name="form"
			action="userServlet?method=userLogin" method="post">
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">User</label>
				<div class="col-sm-10">
					<input type="email" class="form-control login_input" id="inputEmail3"
						style="width:300px;float:left" placeholder="Email" name="userEmail" onblur="validate()">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control password_input" id="inputPassword3"
						style="width:300px" placeholder="Password" name="password">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-success" style="width:300px">Sign
						in</button>
                    <br>
                    <div class="checkbox" style="float:left;margin-top:17px">
			<label
				style="font-size:14px;font-weight:normal;font-style:italic;margin-bottom:0px;color:black">Not
				a member?</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
		<button type="button" class="btn btn-primary"
			style="width:145px;margin-top:17px"
			onclick="window.location.href='register.jsp'">Register</button>
				</div>
			</div>
		</form>
	</div>
	<div style="margin-top:75px;margin-left:580px">
