...
<head>
<meta charset="utf-8">
<meta http-equiv="refresh" content="5;url='Feedback.jsp'"/>
...
<body>
	<div class="container">
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
			      <div style="font-family:cursive;color:purple;font-size:40px">&nbsp;&nbsp;&nbsp;&nbsp;Thank you for your precious suggestions!The page will jump in 5 seconds...</div>
			</div>
		</div>
	</div>
