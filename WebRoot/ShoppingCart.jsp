...
function emptyShoppingCart() {
		if (confirm('Are you sure to delete?')) {
			...
			window.location = "productServlet?method=emptyShoppingCart";
		}
	}
</script>
</head>
...
<body>
	<div class="container">
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<div>
					<span style="font-family:Myriad Pro;font-size:40px;display:block;text-align:center">My Shopping Cart</span>
					<br />
					<hr style="border: 1.5px solid purple;margin-top:-20px" />
				</div>
				<c:forEach items="${shoppingCartList}" var="row">
				<div style="float:left;margin-left:74px;margin-top:20px">
					 ...
					 <div class="caption">
						...
						<p style="font-size:16px">Bought time: ${ row.butTime }</p>
						<a href="productServlet?method=removeProduct&time=${row.buyTime}" class="btn btn-primary">Remove from ShoppingCart</a>
					 </div>
				</div>
				</c:forEach>
				<div class="clear" style="clear:both;"></div>
				<div><div style="margin-top:30px;margin-left:460px;font-size:30px;"><a href="javascript:emptyShoppingCart()" class="btn btn-danger">Empty ShoppingCart</a>&nbsp;&nbsp;&nbsp;<a href="index.jsp" class="btn btn-success">Continue shopping</a></div>
				     <div style="font-family:Myriad Pro;font-size:35px;text-align:right;margin-top:-45px">Total Cost: ${sum } RMB</div>
				</div>
			</div>
		</div>
	</div>
