	...
	<div class="container">
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<div>
					<span
						style="font-family:Myriad Pro;font-size:34px;text-align:center;">Product
						Details&gt;&gt;<a href="productServlet?method=queryProduct&category=${ productDetails.p_type}">${ productDetails.p_type }</a>&gt;&gt;${productDetails.p_name }</span> <br />
					<hr style="border: 1.5px solid purple;margin-top:0px" />
				</div>
				<div>
					<div style="float:left;"><img alt="Sorry, the product has been deleted!" src=${ productDetails.p_image } width="440"
						height="440"></div>
					<div>
						<div class="mystyle">&nbsp;&nbsp;&nbsp;<strong>
							ID:</strong> ${productDetails.p_id }</div>
						<div class="mystyle">&nbsp;&nbsp;&nbsp;<strong>
							Type:</strong> ${productDetails.p_type }</div>
						<div class="mystyle">&nbsp;&nbsp;&nbsp;<strong>
							Name:</strong> ${productDetails.p_name }</div>
						<div class="mystyle">&nbsp;&nbsp;&nbsp;<strong>
							Price: </strong>${productDetails.p_price } RMB</div>
						<div class="mystyle">&nbsp;&nbsp;&nbsp;<strong>
							Quantity: </strong>${productDetails.p_quantity }</div>
						<div class="mystyle">&nbsp;&nbsp;&nbsp;<strong>
							Added Time: </strong>${productDetails.p_time }</div>
						<div style="margin-top:60px;float:right;"><a href="productServlet?method=addShoppingCart&productID=${productDetails.p_id }" class="btn btn-primary">Add to ShoppingCart</a>&nbsp;&nbsp;&nbsp;<a href="index.jsp" class="btn btn-success">Go Back to Index</a></div>
					</div>
				</div>
				...
				<div>
					<ul class="pager" style="margin-top:50px;">
						<li><a href="productServlet?method=showByPage&move=previous&detailsProductID=${productDetails.p_id }">Prev</a></li>
						<li><a href="productServlet?method=showByPage&move=next&detailsProductID=${productDetails.p_id }">Next</a></li>
					</ul>
				</div>
			</div>
		</div>
